...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} future\_mtl\_spec}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals ,\, Sequences ,\, TLC ,\, future\_mtl}
\fl{}
\fl{ {\CONSTANT} MaxT}
\fl{ {\VARIABLES} p ,\, q ,\, t}
\fl{}
...
\fl{}\al{7}{0}{}
\fl{}\al{8}{0}{}
\fl{ P ( i )}\al{9}{4}{ \.{\defeq}}\al{9}{5}{ p [ i ]}
\fl{ Q ( i )}\al{10}{4}{ \.{\defeq}}\al{10}{5}{ q [ i ]}
\fl{}
\fl{}
\fl{ From2True ( i ) \.{\defeq} i \.{\geq} 2}
 \fl{ PhiU ( i )}\al{14}{4}{ \.{\defeq}}\al{14}{5}{ i}\al{14}{6}{
 \.{<}}\al{14}{7}{ 3}
 \fl{ PsiU ( i )}\al{15}{4}{ \.{\defeq}}\al{15}{5}{ i}\al{15}{6}{
 \.{=}}\al{15}{7}{ 3}
\fl{}
\fl{ Init}\al{17}{1}{ \.{\defeq}}
 \fl{ \.{\land}}\al{18}{1}{ p}\al{18}{2}{ \.{=}}\al{18}{3}{ [ i}\al{18}{5}{
 \.{\in}}\al{18}{6}{ 0 \.{\dotdot} MaxT}\al{18}{9}{ \.{\mapsto}}\al{18}{10}{
 {\IF} i \.{\in} 1 \.{\dotdot} 3 \.{\THEN} {\TRUE} \.{\ELSE} {\FALSE} ]}
 \fl{ \.{\land}}\al{19}{1}{ q}\al{19}{2}{ \.{=}}\al{19}{3}{ [ i}\al{19}{5}{
 \.{\in}}\al{19}{6}{ 0 \.{\dotdot} MaxT}\al{19}{9}{ \.{\mapsto}}\al{19}{10}{
 i \.{=} 3 ]}
\fl{ \.{\land}}\al{20}{1}{ t}\al{20}{2}{ \.{=} 0}
\fl{}
\fl{ Step}\al{22}{1}{ \.{\defeq}}
\fl{ \.{\land}}\al{23}{1}{ {\UNCHANGED} {\langle} p ,\, q {\rangle}}
 \fl{ \.{\land}}\al{24}{1}{ {\IF} t \.{<} MaxT \.{\THEN} t \.{'} \.{=} t \.{+}
 1 \.{\ELSE} t \.{'} \.{=} t}
\fl{}
 \fl{ vars}\al{26}{1}{ \.{\defeq}}\al{26}{2}{ {\langle} p ,\, q ,\, t
 {\rangle}}
 \fl{ Spec}\al{27}{1}{ \.{\defeq}}\al{27}{2}{ Init \.{\land} {\Box} [ Step ]_{
 vars} \.{\land} {\WF}_{ vars} ( Step )}
\fl{}
\fl{}
\fl{}
 \fl{ Prop\_FI\_Closed\_Pos}\al{31}{1}{ \.{\defeq}}\al{31}{2}{ {\Box} (
 t}\al{31}{5}{ \.{\leq}}\al{31}{6}{ 2}\al{31}{7}{ \.{\implies}}\al{31}{8}{
 F\_I ( Closed ( 1 ,\, 3 ) ,\, P ,\, t ,\, MaxT ) )}
 \fl{ Prop\_FI\_Closed\_Neg}\al{32}{1}{ \.{\defeq}}\al{32}{2}{ {\Box} (
 t}\al{32}{5}{ \.{\geq}}\al{32}{6}{ 3}\al{32}{7}{ \.{\implies}}\al{32}{8}{
 {\lnot} F\_I ( Closed ( 1 ,\, 3 ) ,\, P ,\, t ,\, MaxT ) )}
 \fl{ Prop\_FI\_From\_Pos}\al{33}{1}{ \.{\defeq} {\Box} ( t}\al{33}{5}{
 \.{\leq} MaxT \.{-} 2 \.{\implies} F\_I ( From ( 2 ) ,\, From2True ,\, t ,\,
 MaxT ) )}
 \fl{ Prop\_FI\_From\_Neg}\al{34}{1}{ \.{\defeq} {\Box} ( {\lnot} F\_I ( From
 ( 4 ) ,\, P ,\, t ,\, MaxT ) )}
\fl{}
\fl{}
 \fl{ Prop\_GI\_From\_Pos}\al{37}{1}{ \.{\defeq}}\al{37}{2}{ {\Box} G\_I (
 From ( 2 ) ,\, From2True ,\, t ,\, MaxT )}
 \fl{ Prop\_GI\_Closed\_Pos}\al{38}{1}{ \.{\defeq}}\al{38}{2}{ {\Box} ( t
 \.{=} 0 \.{\implies} G\_I ( Closed ( 1 ,\, 3 ) ,\, P ,\, t ,\, MaxT ) )}
 \fl{ Prop\_GI\_Closed\_Neg}\al{39}{1}{ \.{\defeq} {\Box} ( ( t \.{\geq} 3
 \.{\land} t \.{\leq} MaxT \.{-} 1 ) \.{\implies} {\lnot} G\_I ( Closed ( 1
 ,\, 3 ) ,\, P ,\, t ,\, MaxT ) )}
\fl{}
\fl{}
 \fl{ Prop\_FI\_Closed\_VacuousNeg}\al{42}{1}{ \.{\defeq}}\al{42}{2}{ {\Box} (
 t}\al{42}{5}{ \.{=}}\al{42}{6}{ MaxT}\al{42}{7}{ \.{\implies} {\lnot} F\_I (
 Closed ( 1 ,\, 3 ) ,\, P ,\, t ,\, MaxT ) )}
 \fl{ Prop\_GI\_Closed\_VacuousPos}\al{43}{1}{ \.{\defeq}}\al{43}{2}{ {\Box} (
 t}\al{43}{5}{ \.{=}}\al{43}{6}{ MaxT}\al{43}{7}{ \.{\implies} G\_I ( Closed
 ( 1 ,\, 3 ) ,\, P ,\, t ,\, MaxT ) )}
 \fl{ Prop\_FI\_From\_Boundary\_Neg}\al{44}{1}{ \.{\defeq} {\Box} (
 t}\al{44}{5}{ \.{=} MaxT \.{-} 1 \.{\implies} {\lnot} F\_I ( From ( 2 ) ,\,
 From2True ,\, t ,\, MaxT ) )}
\fl{}
\fl{}
 \fl{ Prop\_UI\_Pos}\al{47}{1}{ \.{\defeq}}\al{47}{2}{ {\Box} ( t}\al{47}{5}{
 \.{\leq} 3 \.{\implies} U\_I ( Closed ( 0 ,\, 3 ) ,\, PhiU ,\, PsiU ,\, t
 ,\, MaxT ) )}
 \fl{ Prop\_UI\_Neg}\al{48}{1}{ \.{\defeq}}\al{48}{2}{ {\Box} ( t}\al{48}{5}{
 \.{=} 0 \.{\implies} {\lnot} U\_I ( Closed ( 0 ,\, 2 ) ,\, PhiU ,\, PsiU ,\,
 t ,\, MaxT ) )}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
