...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} future\_mtl}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals ,\, Sequences ,\, TLC}
\fl{}
\fl{}
\fl{}\al{4}{0}{}
\fl{}\al{5}{0}{}
 \fl{ Interval \.{\defeq} [ type \.{:} \{\@w{closed} ,\,\@w{from} \} ,\, l
 \.{:} Nat ,\, u \.{:} Nat ]}
\fl{}
 \fl{ Closed ( l ,\, u )}\al{8}{6}{ \.{\defeq}}\al{8}{7}{ [ type}\al{8}{9}{
 \.{\mapsto}}\al{8}{10}{\@w{closed} ,\, l}\al{8}{13}{ \.{\mapsto}}\al{8}{14}{
 l ,\, u}\al{8}{17}{ \.{\mapsto}}\al{8}{18}{ u ]}
 \fl{ From ( l )}\al{9}{4}{ \.{\defeq}}\al{9}{5}{ [ type}\al{9}{7}{
 \.{\mapsto}}\al{9}{8}{\@w{from} ,\, l}\al{9}{11}{ \.{\mapsto}}\al{9}{12}{ l
 ,\, u}\al{9}{15}{ \.{\mapsto}}\al{9}{16}{ 0 ]}
\fl{}
\fl{ Min ( a ,\, b ) \.{\defeq} {\IF} a \.{\leq} b \.{\THEN} a \.{\ELSE} b}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ Upper ( I ,\, t ,\, MaxT ) \.{\defeq}}
 \fl{ {\IF} I . type \.{=}\@w{closed} \.{\THEN} Min ( I . u ,\, MaxT \.{-} t )
 \.{\ELSE} MaxT \.{-} t}
\fl{}
\fl{}
\fl{}\al{22}{0}{}
\fl{}\al{23}{0}{}
\fl{ F\_I ( I ,\, Phi ( \_ ) ,\, t ,\, MaxT ) \.{\defeq}}
 \fl{ \E\, k \.{\in} I . l \.{\dotdot} Upper ( I ,\, t ,\, MaxT ) \.{:} Phi (
 t \.{+} k )}
\fl{}
\fl{ G\_I ( I ,\, Phi ( \_ ) ,\, t ,\, MaxT ) \.{\defeq}}
 \fl{ \A\, k \.{\in} I . l \.{\dotdot} Upper ( I ,\, t ,\, MaxT ) \.{:} Phi (
 t \.{+} k )}
\fl{}
\fl{ U\_I ( I ,\, Phi ( \_ ) ,\, Psi ( \_ ) ,\, t ,\, MaxT ) \.{\defeq}}
 \fl{ \E\, k \.{\in} I . l \.{\dotdot} Upper ( I ,\, t ,\, MaxT )
 \.{:}}\al{31}{16}{ \.{\land}}\al{31}{17}{ Psi ( t \.{+} k )}
 \fl{ \.{\land}}\al{32}{1}{ \A\, m \.{\in} I . l \.{\dotdot} k \.{-} 1 \.{:}
 Phi ( t \.{+} m )}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
